...
% Lens 1 (two faces)
S = S.addSurface('sphericalSurface', 'center',[16 0 0],  'axis',[-1 0 0], 'radius',25*10, 'aperture',12.5*10,'indexcenter','BK7');
S = S.addSurface('sphericalSurface', 'center',[17 0 0],  'axis',[+1 0 0], 'radius',25*10, 'aperture',12.5*10,'indexcenter','sf11');


% Lens 2 (two faces)
S = S.addSurface('sphericalSurface', ...
    'center',[317   0 0], 'axis',[-1 0 0], 'radius',33*10, 'aperture',7.4*10, ...
    'indexcenter','BK7', 'indexout',1.00, 'autoStop',true);
S = S.addSurface('sphericalSurface', ...
...
S = S.addSurface('sphericalSurface', ...
    ...
    'indexcenter','CaF2', 'indexout',1, 'autoStop',true);
S = S.addSurface('sphericalSurface', ...
    'center',[698   0 0], 'axis',[+1 0 0], 'radius',5*10,  'aperture',5.0*10, ...
    'indexcenter','CaF2', 'indexout',1.00, 'autoStop',true);
